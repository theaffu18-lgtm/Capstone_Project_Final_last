    ...
    <div className="min-h-screen bg-[#f5f7fb] overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-28">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-4xl p-10 shadow-lg border border-[#eef0f5] hover:-translate-y-3 transition-all duration-300">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pb-28">
        ...
        <div className="bg-linear-to-r from-[#0066cc] to-[#4d94ff] rounded-[40px] p-14 text-center shadow-2xl">
